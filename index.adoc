...
- model code is fixed
- **ResNet** (https://arxiv.org/pdf/1512.03385.pdf[v1], https://arxiv.org/pdf/1603.05027.pdf[v2]) with Keras+TensorFlow or just TensorFlow (code adopted from official repos)
